...
After:
			if (window is Maui.IElement fe && fe.Handler?.MauiContext != null)
			{
				return fe.Handler.MauiContext;
			}
			...
			return fallbackToAppMauiContext ? Application.Handler?.MauiContext;
*/
...
*/
			...
			return window.Current?.FindMauiContext() : default;
		}
